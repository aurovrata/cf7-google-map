(function($){
  $(document).ready( function(){
    /** @since 1.7.0 emable multi map-fields in page/form */
    $('.cf7-google-map-container').each(function(){
      ...
      if(! cf7GoogleMap.plane_mode){
        if($form.is('.cf7_2_post form.wpcf7-form')){
          let id = $form.closest('.cf7_2_post').attr('id');
          $form.on(id, function(event){
            init();
          });
        }else{
          init();
