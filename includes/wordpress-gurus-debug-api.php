...
if ( ! function_exists( 'debug_msg' ) ) {
	 ...
	 * @param mixed $message to log if in debug mode, can be a string or an object or an array.
	 * @param String $prefix any strong to prefix the message/oject.
	 * @param mixed $trace either a trace count or a boolean true to print the entire strack trace.
	 */
